...
source_image = "dobra.png"     # USER PARAM
# bad image entered by user
input_image = "zla.png"     # USER PARAM


'''Dividing into tiles'''
number_of_tiles = tile(source_image, "output/", list_of_frames, div_w=5, div_h=5)
...
for i in range(howDeep):
    ...
    for frame in list_of_frames:
        number_of_tiles = tile(frame.tilefname, "output_temp/", deep_list_of_frames, div_w=3, div_h=2, offset=frame.offset)
